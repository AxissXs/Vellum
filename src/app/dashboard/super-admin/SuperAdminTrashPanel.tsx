    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-wrap items-center gap-3">
        ...
        <div className="flex items-center gap-2 bg-slate-50 rounded-lg px-3 py-2 border border-slate-200">
          ...
          <input
            ...
            className="bg-transparent text-sm text-slate-900 outline-none w-40"
          />
        </div>
        ...
        {selectedIds.size > 0 && (
          <button
            ...
            className="flex items-center gap-2 rounded-lg bg-emerald-500/10 text-emerald-600 border border-emerald-500/20 px-4 py-2 text-sm font-medium hover:bg-emerald-500/20 transition"
          >
            <RotateCcw size={14} />
            ...
            {items.length === 0 ? (
              ...
              items.map((item) => (
                ...
                >
                  ...
                  <td className="px-4 py-3">
                    <p className="text-slate-900 truncate max-w-xs">{item.title}</p>
        ...
        <div className="flex items-center justify-between">
          ...
          <div className="flex items-center gap-2">
            <button
              ...
              disabled={page <= 1}
              className="p-1.5 rounded-lg border border-slate-200 text-slate-500 hover:text-slate-700 disabled:opacity-30"
            >
              <ChevronLeft size={16} />
            </button>
      ...
      {confirmRestore && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/40 backdrop-blur-sm">
          <div className="bg-white border border-slate-200 rounded-xl p-6 max-w-md w-full mx-4 shadow-xl">
            <div className="flex items-center gap-3 mb-4">
              <div className="h-10 w-10 rounded-full bg-emerald-500/10 flex items-center justify-center">
                <RotateCcw size={18} className="text-emerald-600" />
              </div>
              <div>
                <h3 className="text-lg font-semibold text-slate-900">Restore Items</h3>
            ...
            <div className="max-h-40 overflow-y-auto space-y-1 mb-4 bg-slate-50 rounded-lg p-3 border border-slate-200">

      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-4">
        ...
        <div className="bg-white border border-slate-200 rounded-xl p-5">
          <div className="flex items-center gap-2 mb-4">
            ...
            <h3 className="text-sm font-medium text-slate-900">User Status</h3>
          </div>
        ...
        <div className="bg-white border border-slate-200 rounded-xl p-5">
          <div className="flex items-center gap-2 mb-4">
            ...
            <h3 className="text-sm font-medium text-slate-900">Last 24 Hours</h3>
          </div>
        ...
        <div className="bg-white border border-slate-200 rounded-xl p-5">
          <div className="flex items-center gap-2 mb-4">
            ...
            <h3 className="text-sm font-medium text-slate-900">Top Actions (24h)</h3>
          </div>
          <div className="space-y-2">
            {data.actionBreakdown.map((item) => (
              ...
              >
                <span className="text-sm text-slate-500 truncate mr-3">
                  {item.action}
                </span>

            ...
            return (
              <div key={category}>
                <button
                  ...
                  className="w-full flex items-center justify-between px-5 py-3 text-sm font-medium text-slate-600 hover:bg-brand-50 transition"
                >
                  <span>{category}</span>
                  <ChevronDown
                    size={14}
                    ...
                    <table className="w-full text-left text-sm">
                      <thead>
                        <tr className="border-b border-slate-200 bg-white/[0.01]">
                          <th className="px-5 py-2 font-medium text-slate-500 w-1/3">
                            Permission
                          </th>
                          {roles.map((role) => (
                            <th
                      ...
                      <tbody className="divide-y divide-slate-100">
                        {perms.map((perm) => (
                          <tr
                            key={perm.id}
                            className="hover:bg-brand-50 transition"
                          >

...
- Tables: `users`, `teams`, `team_members`, `projects`, `project_milestones`, `project_notes`, `tasks`, `comments`, `sessions`, `activity_logs`, `user_sessions`, `push_subscriptions`, `notification_preferences`
- Enums: `user_role`, `task_status`, `task_priority`, `user_status`, `notification_event_type`

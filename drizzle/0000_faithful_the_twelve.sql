...
CREATE TABLE "team_members" (
	...
	"user_id" uuid NOT NULL,
	"project_id" uuid,
	"team_role" text DEFAULT 'contributor' NOT NULL,
	"allocation" text DEFAULT '100' NOT NULL,
...
ALTER TABLE "project_milestones" ADD CONSTRAINT "project_milestones_owner_id_users_id_fk" FOREIGN KEY ("owner_id") REFERENCES "public"."users"("id") ON DELETE set null ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "teams" ADD CONSTRAINT "teams_lead_id_users_id_fk" FOREIGN KEY ("lead_id") REFERENCES "public"."users"("id") ON DELETE set null ON UPDATE no action;
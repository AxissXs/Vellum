...
ALTER TABLE "activity_log_snapshots" ADD CONSTRAINT "activity_log_snapshots_log_id_activity_logs_id_fk" FOREIGN KEY ("log_id") REFERENCES "public"."activity_logs"("id") ON DELETE cascade ON UPDATE no action;